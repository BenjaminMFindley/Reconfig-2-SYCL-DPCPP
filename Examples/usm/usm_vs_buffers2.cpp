...
//
// Based on these results, buffers are the least effective way of transferring
...
//
// Both implicit modes (shares and host) showed the biggest percentage improvement,
